...
!function(a, b) {
  ...
  var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {},
      i = h.toString, j = h.hasOwnProperty, k = ''.trim, l = {}, m = '1.11.0',
      n =
          function(a, b) {
  ...
  var t = function(a) {
    var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r,
        s = 'sizzle' + -new Date, t = a.document, u = 0, v = 0, w = eb(),
        x = eb(), y = eb(),
        z =
            function(a, b) {
          return a === b && (j = !0), 0
        },
        A = 'undefined', B = 1 << 31, C = {}.hasOwnProperty, D = [], E = D.pop,
        ...
        R = new RegExp('^' + K + '*([>+~]|' + K + ')' + K + '*'),
        S = new RegExp('=' + K + '*([^\\]\'"]*?)' + K + '*\\]', 'g'),
        T = new RegExp(O), U = new RegExp('^' + M + '$'), V = {
          ID: new RegExp('^#(' + L + ')'),
          CLASS: new RegExp('^\\.(' + L + ')'),
    ...
    function db(a, b, d, e) {
      ...
      if (n && !e) {
          ...
          if (h = f[1]) {
            if (9 === i) {
              ...
              if (g.id === h) return d.push(g), d
                ...
                b.ownerDocument && (g = b.ownerDocument.getElementById(h)) &&
                r(b, g) && g.id === h)
              return d.push(g), d
          } else {
        ...
        if (c.qsa && (!o || !o.test(a))) {
          if (q = p = s, u = b, v = 9 === i && a,
              1 === i && 'object' !== b.nodeName.toLowerCase()) {
            m = ob(a),
            (p = b.getAttribute('id')) ? q = p.replace(_, '\\$&') :
                                         b.setAttribute('id', q),
            q = '[id=\'' + q + '\'] ', j = m.length;
      ...
      return e !== l && 9 === e.nodeType && e.documentElement ?
          (l = e, m = e.documentElement, n = !f(e),
           ...
           c.getElementsByClassName =
               Y.test(e.getElementsByClassName) && gb(function(a) {
                 return a.innerHTML =
                       ...
                       (delete d.find.ID,
                        d.filter.ID =
                            function(a) {
                              var b = a.replace(ab, bb);
                              return function(a) {
                                var c = typeof a.getAttributeNode !== A &&
           ...
           (c.matchesSelector = Y.test(
                q = m.webkitMatchesSelector || m.mozMatchesSelector ||
                    m.oMatchesSelector || m.msMatchesSelector)) &&
               gb(function(a) {
                 c.disconnectedMatch = q.call(a, 'div'),
                 q.call(a, '[s!=\'\']:x'), p.push('!=', O)
               }),
               ...
               function(a, b) {
                 ...
                 if (!f || !g)
                   return a === e ?
                       ...
                       b === e ?
                       1 :
                       f ? -1 : g ? 1 : i ? I.call(i, a) - I.call(i, b) : 0;
    ...
    db.uniqueSort =
        function(a) {
      var b, d = [], e = 0, f = 0;
      if (j = !c.detectDuplicates, i = !c.sortStable && a.slice(0), a.sort(z),
          j) {
    ...
    function tb(a, b, c, d, e, f) {
      return d && !d[s] && (d = tb(d)), e && !e[s] && (e = tb(e, f)),
             fb(function(f, g, h, i) {
        ...
        if (c = d.relative[a[j].type])
          ...
          if (c = d.filter[a[j].type].apply(null, a[j].matches), c[s]) {
            ...
            return tb(
                ...
                c, e > j && ub(a.slice(j, e)), f > e && ub(a = a.slice(e)),
                f > e && pb(a))
          }
          m.push(c)
        }
    ...
    function xb(a, b, e, f) {
      ...
      if (!f && 1 === m.length) {
        if (i = m[0] = m[0].slice(0),
            i.length > 2 && 'ID' === (j = i[0]).type && c.getById &&
          ...
          if (c[1]) {
            if (b = b instanceof n ? b[0] : b,
                n.merge(
                    this,
                    n.parseHTML(
                        c[1], b && b.nodeType ? b.ownerDocument || b : z, !0)),
  ...
  n.extend({
    ...
    sibling: function(a, b) {
      ...
      n.fn.extend({
        ...
        index: function(a) {
          return a ?
              'string' == typeof a ? n.inArray(this[0], n(a)) :
    ...
    _removeData: function(a, b) {
      ...
      n.extend({
        queue: function(a, b, c) {
          var d;
          return a ?
              (b = (b || 'fx') + 'queue', d = n._data(a, b),
               c &&
                   (!d || n.isArray(c) ? d = n._data(a, b, n.makeArray(c)) :
                                         d.push(c)),
               d || []) :
              void 0
        },
  ...
  !function() {
    ...
    if (b.setAttribute('className', 't'),
        ...
        l.appendChecked = c.checked, b.innerHTML = '<textarea>x</textarea>',
  ...
  var Y = /^(?:input|select|textarea)$/i, Z = /^key/,
      $ = /^(?:mouse|contextmenu)|click/, _ = /^(?:focusinfocus|focusoutblur)$/,
      ab = /^([^.]*)(?:\.(.+)|)$/;
  function bb() {
    return !0
  }
  ...
  n.event = {
    ...
    remove: function(a, b, c, d, e) {
      ...
      if (r && (k = r.events)) {
        ...
        while (j--)
          if (h = ab.exec(b[j]) || [], o = q = h[1],
              p = (h[2] || '').split('.').sort(), o) {
            l = n.event.special[o] || {},
            o = (d ? l.delegateType : l.bindType) || o, m = k[o] || [],
            h = h[2] &&
                new RegExp('(^|\\.)' + p.join('\\.(?:.*\\.|)') + '(\\.|$)'),
            i = f = m.length;
            while (f--)
    ...
    trigger: function(b, c, d, e) {
      var f, g, h, i, k, l, m,
          o = [d || z], p = j.call(b, 'type') ? b.type : b,
      ...
      if (h = l = d = d || z,
        ...
        if (b.type = p,
            !e && !b.isDefaultPrevented() &&
                ...
                n.acceptData(d) && g && d[p] && !n.isWindow(d)) {
          ...
          while ((e = f.handlers[g++]) && !a.isImmediatePropagationStopped())
            (!a.namespace_re || a.namespace_re.test(e.namespace)) &&
                (a.handleObj = e, a.data = e.data,
                 c = ((n.event.special[e.origType] || {}).handle || e.handler)
                         .apply(f.elem, i),
        ...
        for (; i != this; i = i.parentNode || this)
          if (1 === i.nodeType && (i.disabled !== !0 || 'click' !== a.type)) {
            for (e = [], f = 0; h > f; f++)
              d = b[f], c = d.selector + ' ',
              void 0 === e[c] &&
                  (e[c] = d.needsContext ? n(c, this).index(i) >= 0 :
    ...
    mouseHooks: {
      ...
      filter: function(a, b) {
        ...
        return null == a.pageX && null != b.clientX &&
                   (d = a.target.ownerDocument || z, e = d.documentElement,
                    c = d.body,
                    a.pageX = b.clientX +
    ...
    simulate: function(a, b, c, d) {
      var e = n.extend(
          new n.Event, c, {type: a, isSimulated: !0, originalEvent: {}});
  ...
  var fb =
      ...
      hb = new RegExp('<(?:' + fb + ')[\\s/>]', 'i'), ib = /^\s+/,
      jb =
          /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
      kb = /<([\w:]+)/, lb = /<tbody/i, mb = /<|&#?\w+;/,
      nb = /<(?:script|style|link)/i, ob = /checked\s*(?:[^=]|=\s*.checked.)/i,
      pb = /^$|\/(?:java|ecma)script/i, qb = /^true\/(.*)/,
      rb = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, sb = {
  ...
  sb.tbody = sb.tfoot = sb.colgroup = sb.caption = sb.thead, sb.th = sb.td;
  function vb(a, b) {
    var c, d, e = 0,
  ...
  n.extend({
    ...
    buildFragment: function(a, b, c, d) {
      for (var e, f, g, h, i, j, k, m = a.length, o = eb(b), p = [], q = 0;
        ...
        if (f = a[q], f || 0 === f)
          if ('object' === n.type(f))
            ...
            if (!l.leadingWhitespace && ib.test(f) &&
      ...
      h && o.removeChild(h), l.appendChecked || n.grep(vb(p, 'input'), wb),
          q = 0;
      while (f = p[q++])
    ...
    cleanData: function(a, b) {
      for (var d, e, f, g, h = 0, i = n.expando, j = n.cache,
                           k = l.deleteExpando, m = n.event.special;
           null != (d = a[h]); h++)
        if ((b || n.acceptData(d)) && (f = d[i], g = f && j[f])) {
          ...
          j[f] &&
              (delete j[f],
               k ? delete d[i] :
                   typeof d.removeAttribute !== L ? d.removeAttribute(i) :
                                                    d[i] = null,
               c.push(f))
        }
    }
      ...
      n.fn.extend({
        ...
        replaceWith: function() {
          ...
          return this.domManip(arguments, function(b) {
            a = this.parentNode, n.cleanData(vb(this)),
        ...
        domManip: function(a, b) {
          a = e.apply([], a);
          var c, d, f, g, h, i, j = 0, k = this.length, m = this, o = k - 1,
          ...
          if (k &&
            ...
            if (f)
              for (h = g[g.length - 1].ownerDocument, n.map(g, zb), j = 0;
                   f > j; j++)
                d = g[j],
                pb.test(d.type || '') && !n._data(d, 'globalEval') &&
                    n.contains(h, d) &&
                    (d.src ?
                         n._evalUrl && n._evalUrl(d.src) :
                         n.globalEval((d.text || d.textContent || d.innerHTML ||
                                       '').replace(rb, '')));
            i = c = null
          }
          return this
      ...
      n.each(
          ...
          function(a, b) {
            n.fn[a] = function(a) {
              for (var c, d = 0, e = [], g = n(a), h = g.length - 1; h >= d;
                   d++)
                c = d === h ? this : this.clone(!0), n(g[d])[b](c),
                f.apply(e, c.get());
                ...
                'none' !== c && c ||
                    (Db =
                     ...
                     b = (Db[0].contentWindow || Db[0].contentDocument)
                             .document,
                     b.write(), b.close(), c = Fb(a, b), Db.detach()),
                Eb[a] = c),
           c
  }
  !function() {
    ...
    l.opacity = /^0.5/.test(a.style.opacity), l.cssFloat = !!a.style.cssFloat,
    c.style.backgroundClip = 'content-box',
    c.cloneNode(!0).style.backgroundClip = '',
    l.clearCloneStyle = 'content-box' === c.style.backgroundClip, a = c = null,
    l.shrinkWrapBlocks = function() {
      var a, c, e, f;
      if (null == b) {
        if (a = z.getElementsByTagName('body')[0], !a) return;
        f = 'border:0;width:0;height:0;position:absolute;top:0;left:-9999px',
        c = z.createElement('div'), e = z.createElement('div'),
        a.appendChild(c).appendChild(e), b = !1,
        typeof e.style.zoom !== L &&
            (e.style.cssText = d + ';width:1px;padding:1px;zoom:1',
             e.innerHTML = '<div></div>', e.firstChild.style.width = '5px',
             b = 3 !== e.offsetWidth),
  ...
  var Hb = /^margin/, Ib = new RegExp('^(' + T + ')(?!px)[a-z%]+$', 'i'), Jb,
      Kb, Lb = /^(top|right|bottom|left)$/;
  a.getComputedStyle ?
      (Jb =
           function(a) {
      ...
      z.documentElement.currentStyle &&
          (Jb =
           ...
           Kb =
               function(a, b, c) {
                 var d, e, f, g, h = a.style;
                 return c = c || Jb(a), g = c ? c[b] : void 0,
                        null == g && h && h[b] && (g = h[b]),
                        Ib.test(g) && !Lb.test(b) &&
  ...
  !function() {
    ...
    l.opacity = /^0.5/.test(b.style.opacity), l.cssFloat = !!b.style.cssFloat,
    h.style.backgroundClip = 'content-box',
    h.cloneNode(!0).style.backgroundClip = '',
    l.clearCloneStyle = 'content-box' === h.style.backgroundClip, b = h = null,
    n.extend(l, {
      reliableHiddenOffsets: function() {
        ...
        if (f)
          return e.setAttribute('className', 't'),
                 e.innerHTML =
                     '  <link/><table></table><a href=\'/a\'>a</a><input type=\'checkbox\'/>',
                 a = z.createElement('div'), a.style.cssText = i,
                 f.appendChild(a).appendChild(e),
                 e.innerHTML = '<table><tr><td></td><td>t</td></tr></table>',
                 b = e.getElementsByTagName('td'),
                 b[0].style.cssText =
                     'padding:0;margin:0;border:0;display:none',
                 d = 0 === b[0].offsetHeight, b[0].style.display = '',
                 b[1].style.display = 'none', c = d && 0 === b[0].offsetHeight,
      ...
      reliableMarginRight: function() {
        ...
        if (null == g && a.getComputedStyle) {
          ...
          c = z.createElement('div'), d = z.createElement('div'),
          c.style.cssText = i, b.appendChild(c).appendChild(d),
          e = d.appendChild(z.createElement('div')),
          e.style.cssText = d.style.cssText = j,
          e.style.marginRight = e.style.width = '0', d.style.width = '1px',
    ...
    function k() {
      ...
      h &&
          (b = z.createElement('div'), c = z.createElement('div'),
           b.style.cssText = i, h.appendChild(b).appendChild(c),
           c.style.cssText =
           ...
           a.getComputedStyle &&
               (f = '1%' !== (a.getComputedStyle(c, null) || {}).top,
                e = '4px' ===
                    (a.getComputedStyle(c, null) || {width: '4px'}).width),
           h.removeChild(b), c = h = null)
    }
  }(),
  ...
  function ic(a, b, c) {
    for (var d, e = (fc[b] || []).concat(fc['*']), f = 0, g = e.length; g > f;
         f++)
  ...
  function lc(a, b, c) {
    var d, e,
        f = 0, g = ec.length, h = n.Deferred().always(function() {
          delete i.elem
        }),
        i =
            function() {
  ...
  n.fn.delay = function(a, b) {
    ...
    e.setAttribute('className', 't'),
        e.innerHTML =
            '  <link/><table></table><a href=\'/a\'>a</a><input type=\'checkbox\'/>',
        a = e.getElementsByTagName('a')[0], c = z.createElement('select'),
        d = c.appendChild(z.createElement('option')),
        b = e.getElementsByTagName('input')[0], a.style.cssText = 'top:1px',
        l.getSetAttribute = 't' !== e.className,
        l.style = /top/.test(a.getAttribute('style')),
        l.hrefNormalized = '/a' === a.getAttribute('href'),
        l.checkOn = !!b.value, l.optSelected = d.selected,
        l.enctype = !!z.createElement('form').enctype, c.disabled = !0,
        l.optDisabled = !d.disabled, b = z.createElement('input'),
  ...
  var nc, oc, pc = n.expr.attrHandle, qc = /^(?:checked|selected)$/i,
              rc = l.getSetAttribute, sc = l.input;
  n.fn.extend({
    attr: function(a, b) {
  ...
  n.extend({
    ...
    ajax: function(a, b) {
      ...
      if (o.promise(v).complete = p.add, v.success = v.done, v.error = v.fail,
          ...
          k.dataTypes =
              n.trim(k.dataType || '*').toLowerCase().match(F) || [''],
          null == k.crossDomain &&
          ...
          Nc(Ic, k, b, v), 2 === t)
        return v;
      h = k.global, h && 0 === n.active++ && n.event.trigger('ajaxStart'),
      k.type = k.type.toUpperCase(), k.hasContent = !Fc.test(k.type), e = k.url,
      k.hasContent ||
          (k.data &&
      ...
      if (i = Nc(Jc, k, b, v)) {
        v.readyState = 1, h && m.trigger('ajaxSend', [v, k]),
      ...
      function x(a, b, c, d) {
        ...
        2 !== t &&
            (t = 2, g && clearTimeout(g), i = void 0, f = d || '',
             ...
             c && (u = Pc(k, v, c)), u = Qc(k, u, v, j),
             j ? (k.ifModified &&
                      (w = v.getResponseHeader('Last-Modified'),
                       w && (n.lastModified[e] = w),
                       w = v.getResponseHeader('etag'), w && (n.etag[e] = w)),
                  204 === a || 'HEAD' === k.type ?
                      x = 'nocontent' :
                      304 === a ?
                      x = 'notmodified' :
      ...
      return this
          ...
          .filter(function() {
            ...
            return this.name && !n(this).is(':disabled') &&
                Vc.test(this.nodeName) && !Uc.test(a) &&
  ...
  n.ajaxSettings.xhr = void 0 !== a.ActiveXObject ? function() {
    return !this.isLocal &&
        /^(get|post|head|put|delete|options)$/i.test(this.type) && $c() ||
        _c()
  } : $c;
  ...
  a.ActiveXObject &&
      ...
      l.cors = !!Zc && 'withCredentials' in Zc, Zc = l.ajax = !!Zc,
              ...
              f.send(a.hasContent && a.data || null),
                  b =
                    ...
                    if (b && (e || 4 === f.readyState))
                      if (delete Yc[g], b = void 0,
                          f.onreadystatechange = n.noop, e)
    ...
    converters: {
      ...
      n.ajaxPrefilter('script', function(a) {
        ...
        if (a.crossDomain) {
          ...
          return {
            send: function(d, e) {
              b = z.createElement('script'), b.async = !0,
